const Academics = () => {
  return (
    <div>
        ...
        At Amber Academy our students success is rooted in the future. Students master <br />
         academic and real-world skills today, that will be in demand when they graduate. <br />
                            <br />
        ...
        <div className = "flex flex-row align-middle justify-center bg-[#f0f0f0]">
            <div className = "basis-1/2 py-5">
                <img src = "src/images/Rectangle 112.png" width="500px"/>
            </div>
            ...
            <div className = "pt-24">
                ...
                their mark in the universe. At Amber academy, we believe that <br />
                 every child is full of brilliance and potential. At Amber academy <br />
        ...
        <div className = "flex flex-row-reverse align-middle justify-center bg-[#d3b2b2] pt-5">
            <div className = " py-5">
                <img src = "src/images/abc.png" width="500px"/>
            </div>
            ...
            <div className = "basis-1/2 pt-24 pl-20">
                ...
                Here at Amber Academy we envision every student becoming a <br />
                 world-class scientist, technologist, engineer or mathematician. <br />
                  We encourage students to become critical thinkers & to explore <br />
        ...
        <div className = "flex flex-row align-middle justify-center bg-[#f0f0f0] pt-5">
            <div className = "basis-1/2 py-5">
                <img src = "https://www.brookings.edu/wp-content/uploads/2019/11/CUE_South-Africa_classroom001.jpg" width="500px"/>
            </div>
        ...
        <div className = " my-10">
            ...
            <div className = "flex flex-col mx-32">
                    <div className="basis-1 bg-[#0f3768] my-2 py-3 text-3xl text-white pl-2"> Science & Technology</div>
                    <div className = "basis-1 bg-[#0f3768] my-2 py-3 text-3xl text-white pl-2"> Art & Humanities</div>
                    <div className = "basis-1 bg-[#0f3768] my-2 py-3 text-3xl text-white pl-2"> Commercial</div>
            </div>
        </div>
